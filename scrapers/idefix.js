      ...
      .then(async () => {
        const outputArray = await page.evaluate(
          async (index, scrapingSize, parsedArray, PAGE_LIMIT) => {
              ...
              const parentId = document.querySelector('#items > [class = item]').getAttribute('data-categoryid');

              // Sub category id's for this specific site given static because of the structure of website!!
              const subCategoryIds = [
                11762, 12032, 11802, 11703, 11943, 11751, 15271, 11923, 11872,
                11878, 11727, 11750, 11904, 11908, 11758, 11938
              ];
              const fetchAPI = async (counter, subCategoryIndex) => {
                console.log(`Fetching ${counter} of Category-${subCategoryIds[subCategoryIndex]}`);

                return fetch("https://www.idefix.com/kategori/ekitap", {
                    "headers": {
                      "accept": "*/*",
                      "accept-language": "en-US,en;q=0.9,tr;q=0.8",
                      "content-type": "application/x-www-form-urlencoded; charset=UTF-8",
                      "newrelic": "eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6IjUxMDc5NCIsImFwIjoiMTYxNjYwNzciLCJpZCI6IjY5ZGViNzQ4YTAxYTBhZGUiLCJ0ciI6IjIwZjE3YmRjYjg4ZTQzNzc1ODY0YzY1MTRkOGIwMGFlIiwidGkiOjE2NjM4ODI2MTIwMTZ9fQ==",
                      ...
                      "traceparent": "00-20f17bdcb88e43775864c6514d8b00ae-69deb748a01a0ade-01",
                      "tracestate": "510794@nr=0-1-510794-16166077-69deb748a01a0ade----1663882612016",
              ...
              const scrapeProducts = async (productObject) => {
                ...
                if (div.querySelectorAll('.row .itemlittleProduct .product-info').length < PAGE_LIMIT) paginationFlag = 0;
