                ...
                const outputArray = await page.evaluate(
                    async (
                        ...
                        const fetchAPI = async (counter) => {
                            console.log(
                                `Fetching ${counter} of ${categories[index].URL}`
                            )
                            ...
                            let fetchedData = await fetch(
                                'https://www.dr.com.tr/Catalog/AsyncCategory',
                                {
                                    headers: {
                                        accept: '*/*',
                                        'accept-language': 'en-US,en;q=0.9',
                                        ...
                                        newrelic:
                                            'eyJ2IjpbMCwxXSwiZCI6eyJ0eSI6IkJyb3dzZXIiLCJhYyI6IjUxMDc5NCIsImFwIjoiMTA0NDk5MjkiLCJpZCI6IjRkMmMzMWJiYTJiNDBiNjMiLCJ0ciI6IjQ0ODY3M2YwYmE0ZTI5YThlMjlhNGRmM2VjNjQ2OTVmIiwidGkiOjE2NTcwOTkzNjc4NTN9fQ==',
                                        'sec-ch-ua':
                                            '".Not/A)Brand";v="99", "Google Chrome";v="103", "Chromium";v="103"',
                                        'sec-ch-ua-mobile': '?0',
                                        ...
                                        'sec-fetch-site': 'same-origin',
                                        traceparent:
                                            '00-448673f0ba4e29a8e29a4df3ec64695f-4d2c31bba2b40b63-01',
                                        tracestate:
                                            '510794@nr=0-1-510794-10449929-4d2c31bba2b40b63----1657099367853',
                                    },
                                    referrerPolicy:
                            ...
                            fetchedData.Result.Products.forEach((e) => {
                                let authors = ''

                                e.Persons.Person.forEach((e) => {
                                    if (e.Group.includes('Yazar')) {
                                        authors = authors + e.Name + ' '
                                    }
                                })
                                authors = authors.trim()

                                tempObj.price = e.Price
                                tempObj.rating = e.Rating / 2
                                tempObj.title = e.Name
                                tempObj.publisher = e.Manufacturer
                                tempObj.URL = baseURL + e.Url
                                tempObj.img = 'https://i.dr.com.tr' + e.ImageUrl // for accessing images' URLs
                                tempObj.author = authors
                                tempObj.providedURL = 'dr'
